        ...
        <>
            <div className="wrapper" id="wrapper">
                    <div class="agency">
                        ...
                        Le rôle du développeur est de traduire ce projet en ligne de code, c'est-à-dire utiliser les
                        outils,
                        les technologies et les librairies qui vont lui permettre de mener à bien le projet, mais
                        surtout,
                        trouver les solutions qui vont le rendre disponible sur toutes les tailles d'écrans, de
                        l'ordinateur
